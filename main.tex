...
\begin{enumerate}
    ...
    \item We construct a dual-source module training corpus, comprising \textsc{Mentor}-derived dendrogram modules and random-walk-with-restart lines-of-evidence (RWR-LOE) seed expansion modules, supporting four task cases: partial group completion, mechanism explanation, noisy group refinement, and recognition of no shared mechanism.
