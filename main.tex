...
\begin{itemize}
    ...
    \item "Uncovering disease-disease relationships through the incomplete interactome")
    \item "From molecular to modular cell biology"
\end{itemize}

\subsubsection{Curated Ground Truth: CORUM and Protein Complexes}
\begin{itemize}
    \item \cite{tsitsiridis2023corum}
    \item Giurgiu et al. 2019 (CORUM 3.0 update
    \item BioGRID (Oughtred et al. 2021)
    \item Reactome (Gillespie et al. 2022)
\end{itemize}
...
\begin{itemize}
    ...
    \item De Domenico et al. 2013 (Nature Comm, multiplex network framework
    \item Mucha et al. 2010 (Science, multilayer community detection) for multiplex foundations
    \item \cite{newman2004finding, blondel2008fast} 
    \item \cite{kipf2016semi, velivckovic2017graph} 
\end{itemize}
