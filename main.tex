...
In addition to deep learning's growing utility for biological discovery, neural language models have shown promise for complex reasoning, especially when grounded with tool use. \cite{wei2022chain} demonstrated that prompting a model to show its reasoning steps before answering improved multi-step task performance in a few-shot setting, and \cite{kojima2022large} extended this result to show its effectiveness in a zero-shot scenario. Furthermore, adding self-consistency mechanisms \cite{wang2022self}, reflection and memory \cite{shinn2023reflexion}, and branched reasoning paths with lookahead and backtracking \cite{yao2023tree} have enhanced model reasoning capabilities. 
...
While tool use combined with reasoning improve the model's ability to solve complex tasks, these techniques have no inherent verification mechanism. Several works have explored self-verification through various methods. Self-Refine \cite{madaan2023selfrefine} and Reflexion \cite{shinn2023reflexion} both 
\begin{itemize}
    \item Madaan et al. 2023 Self-Refine \cite{madaan2023selfrefine}
    \item Shinn et al. 2023 Reflexion \cite{shinn2023reflexion}
    \item Asai et al. 2023 Self-RAG \cite{asai2023selfrag}
