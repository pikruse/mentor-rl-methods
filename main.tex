...
In addition to general evaluation, we will stratify our evaluation across several axes: module size, noise, and task type. We will divide module size and noise into three discrete bins each for comparative evaluation. Reporting stratified metrics allows us to analyze how \textsc{Mentor-RL} performs as task difficulty increases and task type changes.
